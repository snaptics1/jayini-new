            ...
            <div className='navbar-parent'>
                <div className='logoSection d-flex justify-content-between container py-2 align-items-center'>
                    ...
                    <div className='d-flex gap-4 align-items-center'>
                        ...
                        <div>
                            <p><a href="tel:+91-9137464646">+91 - 9137464646</a></p>
                            <p><a href="tel:+91-9362454545">+91 - 9362454545</a></p>
                        </div>
                    </div>
                </div>
                        ...
                        >
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item dropdown">
                                    <Link className="nav-link dropdown-toggle" to='/patient-education' onClick={handleNavToggle}>
                                        PATIENT EDUCATION
                                    </Link>
                                    <ul className="dropdown-menu">
                                        <li><Link className="dropdown-item" to="#">Shoulder</Link></li>
                                        <li><Link className="dropdown-item" to="#">Elbow</Link></li>
                                        <li><Link className="dropdown-item" to="#">Wrist & Hand</Link></li>
                                        <li className='dropdownsubitemHoverLast'>
                                            <Link className="dropdown-item dropdown-toggle" to="#">Knee</Link>
                                            <ul className="dropdown-submenu">
                                                <li><Link className="dropdown-item" to="#">Arthritis</Link></li>
                                                <li><Link className="dropdown-item" to="#">Injuries</Link></li>
                                            </ul>
                                        </li>
                                        <li><Link className="dropdown-item" to="#">Spine</Link></li>
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link" to='#' onClick={handleNavToggle}>GALLERY</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link" to='#' onClick={handleNavToggle}>PHYSIOTHERAPY</Link>
                                </li>
                            </ul>
